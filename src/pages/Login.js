    ...
    <div className="grid grid-cols-1 sm:grid-cols-2 h-screen w-full">
      ...
      <div className="flex flex-col justify-center bg-lime-200">
        ...
        <form className="max-w-[400px] w-full mx-auto p-8 px-8 rounded-lg bg-white">
          <h2 className="text-3xl text-center font-bold">Inicia de sesion</h2>
          <div className="flex flex-col py-2">
            <input className=" bg-white mt-2 p-2 border border-black rounded-lg" type="text" placeholder="email"></input>
          </div>
          <div className="flex flex-col py-2">
            <input className=" bg-white mt-2 p-2 border border-black rounded-lg" type="Password" placeholder="password"></input>
          </div>
          <div className="flex flex-col py-2">
            <input className=" bg-white mt-2 p-2 border border-black rounded-lg" type="Password" placeholder="password"></input>
          </div>
